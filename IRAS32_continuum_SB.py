...
execfile('/lustre/cv/projects/edisk/reduction_utils3.py', globals())
...
WD_path = '/lustre/cv/projects/edisk/IRAS32_test/'
SB_path = WD_path+'SB/'
LB_path = WD_path+'LB/'
...
pl_data_params={
    'SB1': {
        'vis': SB_path+'uid___A002_Xebb7f0_X3680.ms',
        'spws': '25,27,29,31,33,35,37'
    },
    'SB2': {
        'vis': SB_path+'uid___A002_Xec0d12_X41ae.ms', 
        'spws': '25,27,29,31,33,35,37'
    },
}
...
data_params = {'SB1': {'vis' : WD_path+prefix+'_SB1.ms',
                       ...
                       'phasecenter': '',
                       'timerange': '2021/05/04/10:19:00~2021/05/04/11:30:00',
                ...
                'SB2':{'vis' : WD_path + prefix + '_SB2.ms', 
                       ...
                       'cont_avg_width':  np.array([480,480,480,480,60,60,60]), #n channels to average; approximately aiming for 30 MHz channels
                       'phasecenter': '',
                       'timerange': '2021/05/15/08:30:00~2021/05/15/10:00:00',
                       'contdotdat' : 'SB/cont.dat'
                      }, 
               }
...
# there are two sources and the masking is confused with other places
mask_ra  =  '19h02m58.721s'.replace('h',':').replace('m',':').replace('s','')
mask_dec = '-37d07m37.372s'.replace('d','.').replace('m','.').replace('s','')
mask_pa  = 90.0 	# position angle of mask in degrees
mask_maj = 0.25	# semimajor axis of mask in arcsec
mask_min = 0.25 	# semiminor axis of mask in arcsec
...
for i in data_params.keys():
       #################### MANUALLY SET THIS ######################
       data_params[i]['common_dir']='J2000 19h02m58.72099s -037d07m37.369766s'
...
### to read the data params from a pickle
#data_params = pickle.load(open(prefix+'.pickle', 'rb'))

###############################################################
################ SELF-CALIBRATION PREPARATION #################
###############################################################
#? which one should I pick? 
# once I start the self-calibration process, I can't start in the middle...

selectedVis='vis_avg_rescaled' # the center is not at the place previously determined
...
#################### MANUALLY SET THIS ######################
#? do the antennae have to exist for all schedule blocks? 
...
#IRAS32_dirty.image.tt0
#Beam 0.227 arcsec x 0.153 arcsec (88.23 deg)
#Flux inside disk mask: 151.17 mJy
#Peak intensity of source: 46.63 mJy/beam
#rms: 3.58e-01 mJy/beam
#Peak SNR: 130.19
...
#Beam 0.226 arcsec x 0.151 arcsec (87.00 deg)
#Flux inside disk mask: 114.39 mJy
#Peak intensity of source: 48.03 mJy/beam
#rms: 7.38e-02 mJy/beam
#Peak SNR: 650.77
...
#Beam 0.226 arcsec x 0.151 arcsec (87.00 deg)
#Flux inside disk mask: 107.14 mJy
#Peak intensity of source: 47.69 mJy/beam
...
#Beam 0.226 arcsec x 0.151 arcsec (87.00 deg)
#Flux inside disk mask: 101.02 mJy
#Peak intensity of source: 47.66 mJy/beam
...
#Beam 0.226 arcsec x 0.151 arcsec (87.00 deg)
#Flux inside disk mask: 99.48 mJy
#Peak intensity of source: 47.62 mJy/beam
...
#Beam 0.229 arcsec x 0.154 arcsec (88.64 deg)
#Flux inside disk mask: 96.45 mJy
#Peak intensity of source: 48.37 mJy/beam
...
#Beam 0.229 arcsec x 0.154 arcsec (89.06 deg)
#Flux inside disk mask: 97.27 mJy
#Peak intensity of source: 48.50 mJy/beam
