...
image_list = {
        ...
        "C18O":dict(chanstart='-5.5km/s', chanwidth='0.35km/s',
            nchan=60, linefreq='219.56035410GHz', linespw=['1','3','3'],
            robust=[2.0,0.5],uvtaper=['2000klambda'],imsize=3000,cellsize='0.01arcsec'),
        ### 13CO images
        "13CO":dict(chanstart='-5.5km/s', chanwidth='0.35km/s',
            nchan=60, linefreq='220.39868420GHz', linespw=['2','4','4'], 
            robust=[2.0,0.5],uvtaper=['2000klambda'],imsize=3000,cellsize='0.01arcsec'),
        ### 12CO images
        "12CO":dict(chanstart='-10km/s', chanwidth='0.65km/s', 
            nchan=70, linefreq='230.538GHz', linespw=['3','0','0'],
            robust=[2.0,0.5],uvtaper=['2000klambda'],imsize=3000,cellsize='0.01arcsec'),
        }
image_list_sb = {
        ### C18O images
        "C18O":dict(chanstart='-5.5km/s', chanwidth='0.333km/s',
            nchan=60, linefreq='219.56035410GHz', linespw='1',
            robust=[0.5,0.],imsize=1600,cellsize='0.025arcsec'),
        ### 13CO images
        "13CO":dict(chanstart='-5.5km/s', chanwidth='0.333km/s',
            nchan=60, linefreq='220.39868420GHz', linespw='2', 
            robust=[0.5],imsize=1600,cellsize='0.025arcsec'),
        ### 12CO images
        "12CO":dict(chanstart='-10km/s', chanwidth='0.635km/s', 
            nchan=315, linefreq='230.538GHz', linespw='0',
            robust=[0.5],imsize=1600,cellsize='0.025arcsec'),
        ### SO Images
        "SO":dict(chanstart='-5.5km/s', chanwidth='0.33km/s', 
            nchan=60, linefreq='219.94944200GHz', linespw='3',
            robust=[0.5],imsize=1600,cellsize='0.025arcsec'),
        }
