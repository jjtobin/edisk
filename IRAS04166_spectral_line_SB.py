...
os.system('rm -rf export_SB')
os.system('mkdir export_SB')
os.system('mv *.fits export_SB/')
os.system('mv *.fits.gz export_SB/')
os.system('mv *.tgz export_SB/')
os.system('mv *.pdf export_SB/')
