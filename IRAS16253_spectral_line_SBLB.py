...
reducer: Y. Aso
Note: I added "12COh" in the image_list, which has a higher velocity resolution, 0.3175 km/s.
I changed image_list[line]["linespw"][1] to image_list[line]["linespw"] in tclean_spectral_line_wrapper() after "if selectedVis=='vis_shift':" in the loop for line clean, because linespw is a single string.
"""
...
image_list = {
        ### C18O images
        "C18O":dict(chanstart='-3.014km/s', chanwidth='0.167km/s',
            nchan=85, linefreq='219.56035410GHz', linespw='3',
            robust=[0.5,2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### 13CO images
        "13CO":dict(chanstart='-3.014km/s', chanwidth='0.167km/s',
            nchan=85, linefreq='220.39868420GHz', linespw='1', 
            robust=[0.5,2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### 12CO images
        "12CO":dict(chanstart='-22.67km/s', chanwidth='0.635km/s', 
            nchan=85, linefreq='230.538GHz', linespw='6',
            robust=[2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### 12CO high vel-res images
        "12COh":dict(chanstart='-22.52km/s', chanwidth='0.3175km/s', 
            nchan=169, linefreq='230.538GHz', linespw='6',
            robust=[0.5,2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### SO Images
        "SO":dict(chanstart='-3.014km/s', chanwidth='0.167km/s', 
            nchan=85, linefreq='219.94944200GHz', linespw='2',
            robust=[0.5,2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### H2CO 3(2,1)-2(2,0) Images
        "H2CO_3_21-2_20_218.76GHz":dict(chanstart='-3.014km/s', 
            chanwidth='0.167km/s', nchan=85, linefreq='218.76006600GHz', 
            linespw='0', robust=[2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### H2CO 3(0,3)-2(0,2) Images
        "H2CO_3_03-2_02_218.22GHz":dict(chanstart='-4.02km/s',
            chanwidth='1.34km/s', nchan=13, linefreq='218.22219200GHz', 
            linespw='4', robust=[2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### H2CO 3(2,2)-2(2,1) Images
        "H2CO_3_22-2_21_218.47GHz":dict(chanstart='-4.02km/s', 
            chanwidth='1.34km/s', nchan=13, linefreq='218.47563200GHz',
            linespw='4', robust=[2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### c-C3H2 217.82 GHz Images
        "cC3H2_217.82":dict(chanstart='-4.02km/s', chanwidth='1.34km/s', 
            nchan=13, linefreq='217.82215GHz', linespw='4', robust=[2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### c-C3H2 217.94 GHz Images
        "cC3H2_217.94":dict(chanstart='-4.02km/s', chanwidth='1.34km/s', 
            nchan=13, linefreq='217.94005GHz', linespw='4', robust=[2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### c-C3H2 218.16 GHz Images
        "cC3H2_218.16":dict(chanstart='-4.02km/s', chanwidth='1.34km/s', 
            nchan=13, linefreq='218.16044GHz', linespw='4', robust=[2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### DCN Images
        "DCN":dict(chanstart='-4.02km/s', chanwidth='1.34km/s', nchan=13, 
            linefreq='217.2386GHz', linespw='4', robust=[2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### CH3OH Images
        "CH3OH":dict(chanstart='-4.02km/s', chanwidth='1.34km/s', nchan=13, 
            linefreq='218.44006300GHz', linespw='4', robust=[2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### SiO Images
        "SiO":dict(chanstart='-110km/s', chanwidth='1.34km/s', nchan=165, 
            linefreq='217.10498000GHz', linespw='4', robust=[2.0],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda'])
        }
