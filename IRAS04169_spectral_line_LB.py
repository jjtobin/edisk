...
if selectedVis == 'vis_shift':
    for i in data_params.keys():
        ...
        fixvis(vis = data_params[i]['vis'],
               outputvis = data_params[i]['vis_shift'], 
...
for i in data_params.keys():
    ...
    data_params[i]['vis_rescaled'] = data_params[i][selectedVis].replace(WD_path, '').replace('.ms', '_rescaled.ms')
...
for i in data_params.keys():
    ...
    applycal(vis = data_params[i]['vis_rescaled'],
             spw = '', 
...
image_list = {
        ...
        "c-C3H2_217.82": dict(chanstart = '-10km/s',
                              chanwidth = '1.34km/s', 
                              nchan = 23,
        ...
        "c-C3H2_217.94": dict(chanstart = '-10km/s',
                             chanwidth = '1.34km/s', 
                             nchan = 23,
                             ...
                             robust = [2.0],
                             imsize = 4000,
                             cellsize = '0.015arcsec',
                             uvtaper = ['2000klambda']),
        ### c-C3H2 218.16 GHz Images
        "c-C3H2_218.16": dict(chanstart = '-10km/s',
                             chanwidth = '1.34km/s', 
                             nchan = 23,
...
for line in image_list:
    ...
    for robust in image_list[line]["robust"]:
        ...
        sigma = get_sensitivity(data_params,
                                specmode = 'cube',
                                spw = [image_list[line]["linespw"]],
                                chan = 450,
                                robust = robust)
        tclean_spectral_line_wrapper(vislist,
                                     imagename,
                                     image_list[line]["chanstart"],
                                     image_list[line]["chanwidth"], 
                                     image_list[line]["nchan"],
                                     image_list[line]["linefreq"], 
                                     image_list[line]["linespw"],
                                     SB_scales,
                                     threshold = 3.0 * sigma,
                                     imsize = image_list[line]["imsize"],
                                     cellsize = image_list[line]["cellsize"],
                                     robust = robust,
                                     uvtaper = image_list[line]["uvtaper"],
    ...
    if selectedVis=='vis_shift':
        tclean_spectral_line_wrapper(data_params['LB1']['vis'],
                                     imagename.replace(prefix, 'temporary.pbfix'),
                                     image_list[line]["chanstart"],
                                     image_list[line]["chanwidth"], 
                                     image_list[line]["nchan"],
                                     image_list[line]["linefreq"], 
                                     image_list[line]["linespw"][1],
                                     LB_scales,
                                     threshold = 3.0 * sigma,
                                     imsize = image_list[line]["imsize"],
                                     cellsize = image_list[line]["cellsize"],
...
for image in imagelist:
    if selectedVis=='vis_shift':
        immath(imagename = [image, image.replace('image', 'pb')],
               expr = 'IM0/IM1',
               outfile = image.replace('image', 'pbcor'),
               imagemd = image)
    else:
        impbcor(imagename = image,
                pbimage = image.replace('image', 'pb'),
                outfile = image.replace('image', 'pbcor'))
