...
pl_data_params={'SB1': {'vis': SB_path+'uid___A002_Xfa2f45_X14241.ms',
                        'spws': '25,31,29,27,33,35,37',
                        'field': field,
                        'column': 'corrected'},
                'LB1': {'vis': LB_path+'uid___A002_Xef9a9d_Xea6.ms',
...
data_params = {'SB1': {'vis' : WD_path+prefix+'_SB1.ms',
                       ...
                       'phasecenter': '',
                       'timerange': '2022/01/14/03:12:41.5~2022/01/14/04:13:27.6',
...
LB1
16h57m19.641666s -16d09m24.01495s
#Peak of Gaussian component identified with imfit: ICRS 16h57m19.641666s -16d09m24.01495s
16h57m19.641666s -16d09m24.01495s
Separation: radian = 7.27333e-08, degrees = 0.000004 = 4.16731e-06, arcsec = 0.015002 = 0.0150023
#Peak in J2000 coordinates: 16:57:19.64237, -016:09:24.003896
#PA of Gaussian component: 45.08 deg
#Inclination of Gaussian component: 72.79 deg
#Pixel coordinates of peak: x = 2991.715 y = 2961.363
LB2
16h57m19.641894s -16d09m24.02154s
#Peak of Gaussian component identified with imfit: ICRS 16h57m19.641894s -16d09m24.02154s
16h57m19.641894s -16d09m24.02154s
Separation: radian = 7.23567e-08, degrees = 0.000004 = 4.14573e-06, arcsec = 0.014925 = 0.0149246
#Peak in J2000 coordinates: 16:57:19.64259, -016:09:24.010486
#PA of Gaussian component: 45.50 deg
#Inclination of Gaussian component: 72.36 deg
#Pixel coordinates of peak: x = 2990.618 y = 2959.166
LB3
16h57m19.642102s -16d09m24.01621s
#Peak of Gaussian component identified with imfit: ICRS 16h57m19.642102s -16d09m24.01621s
16h57m19.642102s -16d09m24.01621s
Separation: radian = 7.24471e-08, degrees = 0.000004 = 4.15091e-06, arcsec = 0.014943 = 0.0149433
#Peak in J2000 coordinates: 16:57:19.64280, -016:09:24.005157
#PA of Gaussian component: 44.95 deg
#Inclination of Gaussian component: 68.06 deg
#Pixel coordinates of peak: x = 2989.622 y = 2960.943
...
for i in data_params.keys():
       #################### MANUALLY SET THIS ######################
       data_params[i]['common_dir']='J2000 16h057m19.642s -16d09m24.012s'
...
mask_pa  = 90.0 	# position angle of mask in degrees
mask_maj = 0.50	# semimajor axis of mask in arcsec
...
#Flux inside disk mask: 48.38 mJy
#Peak intensity of source: 38.32 mJy/beam
...
[18.84990785 13.05183684  9.03720306  6.25743642  4.3327023   3.        ]
'''       
   ...
   for i in data_params.keys():
     if 'SB' in i:
       plotms(vis=data_params[i][selectedVis].replace('.ms','_SB-only_p'+str(iteration)+'.g'),
               xaxis='time', yaxis='phase',gridrows=5,gridcols=5,iteraxis='antenna', xselfscale=True, plotrange=[0,0,-180,180]) 
       input("Press Enter key to advance to next MS/Caltable...")

### Make note of key metrics of image in each round
#CB68_SB-only_p0.image.tt0
#Beam 0.371 arcsec x 0.272 arcsec (82.95 deg)
#Flux inside disk mask: 49.09 mJy
#Peak intensity of source: 38.72 mJy/beam
#rms: 1.57e-01 mJy/beam
#Peak SNR: 246.94

#CB68_SB-only_p0_post.image.tt0
#Beam 0.371 arcsec x 0.272 arcsec (82.95 deg)
#Flux inside disk mask: 50.64 mJy
#Peak intensity of source: 40.05 mJy/beam
#rms: 6.47e-02 mJy/beam
#Peak SNR: 618.98


iteration=1
self_calibrate(prefix,data_params,selectedVis,mode='SB-only',iteration=iteration,selfcalmode='p',nsigma=13.1,solint='inf',
...
#Beam 0.371 arcsec x 0.272 arcsec (82.95 deg)
#Flux inside disk mask: 50.37 mJy
#Peak intensity of source: 40.18 mJy/beam
...
#Peak intensity of source: 40.88 mJy/beam
#rms: 3.92e-02 mJy/beam
#Peak SNR: 1042.27

iteration=2
self_calibrate(prefix,data_params,selectedVis,mode='SB-only',iteration=iteration,selfcalmode='p',nsigma=9.04,solint='90.72s',
               noisemasks=[common_mask,noise_annulus], combine='spw',
               SB_contspws=SB_contspws,SB_spwmap=SB_spwmap,parallel=parallel)
...
if not skip_plots:
   for i in data_params.keys():
     if 'SB' in i:
       plotms(vis=data_params[i][selectedVis].replace('.ms','_SB-only_p'+str(iteration)+'.g'),
               xaxis='time', yaxis='phase',gridrows=5,
               gridcols=5,iteraxis='antenna', xselfscale=True,plotrange=[0,0,-180,180]) 
       input("Press Enter key to advance to next MS/Caltable...")

#CB68_SB-only_p2.image.tt0
#Beam 0.371 arcsec x 0.272 arcsec (82.95 deg)
#Flux inside disk mask: 50.44 mJy
#Peak intensity of source: 40.88 mJy/beam
...
#Beam 0.371 arcsec x 0.272 arcsec (82.95 deg)
#Flux inside disk mask: 50.46 mJy
#Peak intensity of source: 41.09 mJy/beam
#rms: 3.78e-02 mJy/beam
#Peak SNR: 1087.89

iteration=3
self_calibrate(prefix,data_params,selectedVis,mode='SB-only',iteration=iteration,selfcalmode='p',nsigma=6.26,solint='41.34s',
               noisemasks=[common_mask,noise_annulus],combine='spw',
               SB_contspws=SB_contspws,SB_spwmap=SB_spwmap,parallel=parallel)
...
#Beam 0.371 arcsec x 0.272 arcsec (82.95 deg)
#Flux inside disk mask: 50.42 mJy
#Peak intensity of source: 41.04 mJy/beam
#rms: 3.74e-02 mJy/beam
#Peak SNR: 1098.50

#CB68_SB-only_p3_post.image.tt0
#Beam 0.371 arcsec x 0.272 arcsec (82.95 deg)
#Flux inside disk mask: 50.45 mJy
#Peak intensity of source: 41.27 mJy/beam
#rms: 3.74e-02 mJy/beam
#Peak SNR: 1102.65

iteration=4
self_calibrate(prefix,data_params,selectedVis,mode='SB-only',iteration=iteration,selfcalmode='p',nsigma=4.33,solint='18.14s',
               noisemasks=[common_mask,noise_annulus],combine='spw',
               SB_contspws=SB_contspws,SB_spwmap=SB_spwmap,parallel=parallel)
...
#Beam 0.371 arcsec x 0.272 arcsec (82.95 deg)
#Flux inside disk mask: 50.42 mJy
#Peak intensity of source: 41.22 mJy/beam
#rms: 3.70e-02 mJy/beam
#Peak SNR: 1114.24

#CB68_SB-only_p4_post.image.tt0
#Beam 0.371 arcsec x 0.272 arcsec (82.95 deg)
#Flux inside disk mask: 50.47 mJy
#Peak intensity of source: 41.40 mJy/beam
...
#Beam 0.371 arcsec x 0.272 arcsec (82.95 deg)
#Flux inside disk mask: 50.47 mJy
#Peak intensity of source: 41.36 mJy/beam
#rms: 3.66e-02 mJy/beam
#Peak SNR: 1131.44

#CB68_SB-only_p5_post.image.tt0
#Beam 0.371 arcsec x 0.272 arcsec (82.95 deg)
#Flux inside disk mask: 50.56 mJy
#Peak intensity of source: 41.51 mJy/beam
#rms: 3.70e-02 mJy/beam
#Peak SNR: 1123.24
   ...
   for i in data_params.keys():
     if 'SB' in i:
       plotms(vis=data_params[i][selectedVis].replace('.ms','_SB-only_ap'+str(iteration)+'.g'), xaxis='time',
              yaxis='amp',gridrows=5,gridcols=5,iteraxis='antenna', xselfscale=True,plotrange=[0,0,0,2])
       input("Press Enter key to advance to next MS/Caltable...")
#CB68_SB-only_p6.image.tt0
#Beam 0.371 arcsec x 0.272 arcsec (82.95 deg)
#Flux inside disk mask: 50.56 mJy
#Peak intensity of source: 41.46 mJy/beam
#rms: 3.67e-02 mJy/beam
#Peak SNR: 1130.37

#CB68_SB-only_p6_post.image.tt0
#Beam 0.374 arcsec x 0.274 arcsec (82.05 deg)
#Flux inside disk mask: 50.03 mJy
#Peak intensity of source: 41.74 mJy/beam
...
#CB68_SB-only_ap7.image.tt0
#Beam 0.374 arcsec x 0.274 arcsec (82.05 deg)
#Flux inside disk mask: 50.09 mJy
#Peak intensity of source: 41.69 mJy/beam
#rms: 3.63e-02 mJy/beam
#Peak SNR: 1149.59

#CB68_SB-only_ap7_post.image.tt0
#Beam 0.376 arcsec x 0.276 arcsec (81.70 deg)
#Flux inside disk mask: 49.82 mJy
#Peak intensity of source: 41.92 mJy/beam
#rms: 3.70e-02 mJy/beam
#Peak SNR: 1131.75
...
#Beam 0.046 arcsec x 0.035 arcsec (78.89 deg)
#Flux inside disk mask: 52.39 mJy
...
Suggested nsigma per solint: 
[14.74940184  8.67407867  5.10119947  3.        ]
'''
...
iteration=0
self_calibrate(prefix,data_params,selectedVis,mode='LB+SB',iteration=iteration,selfcalmode='p',nsigma=14.75,solint='inf',
               noisemasks=[common_mask,noise_annulus],
...
#Beam 0.046 arcsec x 0.035 arcsec (78.94 deg)
#Flux inside disk mask: 68.10 mJy
...
#Beam 0.046 arcsec x 0.035 arcsec (78.94 deg)
#Flux inside disk mask: 68.62 mJy
...
iteration=1
self_calibrate(prefix,data_params,selectedVis,mode='LB+SB',iteration=iteration,selfcalmode='p',nsigma=8.67,solint='inf',
               noisemasks=[common_mask,noise_annulus],
...
#Beam 0.046 arcsec x 0.035 arcsec (78.94 deg)
#Flux inside disk mask: 67.00 mJy
...
#Beam 0.046 arcsec x 0.035 arcsec (78.94 deg)
#Flux inside disk mask: 66.61 mJy
#Peak intensity of source: 5.62 mJy/beam
#rms: 1.67e-02 mJy/beam
#Peak SNR: 336.20

iteration=2
self_calibrate(prefix,data_params,selectedVis,mode='LB+SB',iteration=iteration,selfcalmode='p',nsigma=5.10,solint='18.14s',
               noisemasks=[common_mask,noise_annulus],
...
#Beam 0.046 arcsec x 0.035 arcsec (78.94 deg)
#Flux inside disk mask: 59.39 mJy
...
#Beam 0.046 arcsec x 0.035 arcsec (78.94 deg)
#Flux inside disk mask: 59.34 mJy
...
self_calibrate(prefix,data_params,selectedVis,mode='LB+SB',iteration=iteration,selfcalmode='p',nsigma=3.0,solint='18.14s',
               ...
               parallel=parallel,combine='spw',smoothfactor=2.0,finalimageonly=True)
...
#Beam 0.046 arcsec x 0.035 arcsec (78.94 deg)
#Flux inside disk mask: 55.56 mJy
