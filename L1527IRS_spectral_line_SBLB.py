## ../casa-6.2.1-7-pipeline-2021.2.0.128/bin/mpicasa -n 9 ../casa-6.2.1-7-pipeline-2021.2.0.128/bin/casa
...
image_list = { # MtvH: added robust=2.0 images
        ### C18O images
        ...
        "H2CO_3_21-2_20_218.76GHz":dict(chanstart='-5.5km/s', 
            ...
            linespw='0', robust=[2.0,0.5],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ...
        "H2CO_3_03-2_02_218.22GHz":dict(chanstart='-10km/s',
            ...
            linespw='4', robust=[2.0,0.5],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ...
        "c-C3H2_217.82":dict(chanstart='-10km/s', chanwidth='1.34km/s', 
            nchan=23, linefreq='217.82215GHz', linespw='4', robust=[2.0,0.5],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### c-C3H2 217.94 GHz Images
        "c-C3H2_217.94":dict(chanstart='-10km/s', chanwidth='1.34km/s', 
            nchan=23, linefreq='217.94005GHz', linespw='4', robust=[2.0,0.5],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### c-C3H2 218.16 GHz Images
        "c-C3H2_218.16":dict(chanstart='-10km/s', chanwidth='1.34km/s', 
            nchan=23, linefreq='218.16044GHz', linespw='4', robust=[2.0,0.5],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### DCN Images
        "DCN":dict(chanstart='-10km/s', chanwidth='1.34km/s', nchan=23, 
            linefreq='217.2386GHz', linespw='4', robust=[2.0,0.5],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### CH3OH Images
        "CH3OH":dict(chanstart='-10km/s', chanwidth='1.34km/s', nchan=23, 
            linefreq='218.44006300GHz', linespw='4', robust=[2.0,0.5],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda']),
        ### SiO Images
        "SiO":dict(chanstart='-100km/s', chanwidth='1.34km/s', nchan=150, 
            linefreq='217.10498000GHz', linespw='4', robust=[2.0,0.5],imsize=4000,cellsize='0.01arcsec',uvtaper=['2000klambda'])
        }
