...
image_list = {
        ### C18O images
        "C18O":dict(chanstart='-10.5km/s', chanwidth='0.167km/s',
            nchan=180, linefreq='219.56035410GHz', linespw='3',
            robust=[2.0],imsize=2000,cellsize='0.01arcsec',uvtaper=['']),
        ### 13CO images
        "13CO":dict(chanstart='-8.0km/s', chanwidth='0.167km/s',
        ...
        "12CO":dict(chanstart='-100.0km/s', chanwidth='0.635km/s', 
            ...
            robust=[2.0],imsize=2000,cellsize='0.01arcsec',uvtaper=['']),
        ### SO Images
        "SO":dict(chanstart='-10.5km/s', chanwidth='0.167km/s', 
            nchan=180, linefreq='219.94944200GHz', linespw='2',
            robust=[2.0],imsize=2000,cellsize='0.01arcsec',uvtaper=['']),
        ### H2CO 3(2,1)-2(2,0) Images
        "H2CO_3_21-2_20_218.76GHz":dict(chanstart='-10.5km/s', 
            chanwidth='0.167km/s', nchan=180, linefreq='218.76006600GHz', 
            linespw='0', robust=[2.0],imsize=2000,cellsize='0.01arcsec',uvtaper=['']),
        ### H2CO 3(0,3)-2(0,2) Images
        "H2CO_3_03-2_02_218.22GHz":dict(chanstart='-15km/s',
            chanwidth='1.34km/s', nchan=30, linefreq='218.22219200GHz', 
            linespw='4', robust=[2.0],imsize=2000,cellsize='0.01arcsec',uvtaper=['']),
        ### H2CO 3(2,2)-2(2,1) Images
        "H2CO_3_22-2_21_218.47GHz":dict(chanstart='-15km/s', 
            chanwidth='1.34km/s', nchan=30, linefreq='218.47563200GHz',
            linespw='4', robust=[2.0],imsize=2000,cellsize='0.01arcsec',uvtaper=['']),
        ### c-C3H2 217.82 GHz Images
        "c-C3H2_217.82":dict(chanstart='-15km/s', chanwidth='1.34km/s', 
            nchan=30, linefreq='217.82215GHz', linespw='4', robust=[2.0],imsize=2000,cellsize='0.01arcsec',uvtaper=['']),
        ### c-C3H2 217.94 GHz Images
        "cC3H2_217.94":dict(chanstart='-15km/s', chanwidth='1.34km/s', 
            nchan=30, linefreq='217.94005GHz', linespw='4', robust=[2.0],imsize=2000,cellsize='0.015arcsec',uvtaper=['']),
        ### c-C3H2 218.16 GHz Images
        "cC3H2_218.16":dict(chanstart='-15km/s', chanwidth='1.34km/s', 
            nchan=30, linefreq='218.16044GHz', linespw='4', robust=[2.0],imsize=2000,cellsize='0.01arcsec',uvtaper=['']),
        ### DCN Images
        "DCN":dict(chanstart='-15km/s', chanwidth='1.34km/s', nchan=30, 
            linefreq='217.2386GHz', linespw='4', robust=[2.0],imsize=2000,cellsize='0.01arcsec',uvtaper=['']),
        ### CH3OH Images
        "CH3OH":dict(chanstart='-15km/s', chanwidth='1.34km/s', nchan=30, 
            linefreq='218.44006300GHz', linespw='4', robust=[2.0],imsize=2000,cellsize='0.01arcsec',uvtaper=['']),
        ### SiO Images
        "SiO":dict(chanstart='-100km/s', chanwidth='1.34km/s', nchan=150, 
            linefreq='217.10498000GHz', linespw='4', robust=[2.0],imsize=2000,cellsize='0.01arcsec',uvtaper=[''])
        }
...
image_list_sb = {
        ...
        ### 13CO images
        "13CO":dict(chanstart='-10.5km/s', chanwidth='0.167km/s',
            nchan=180, linefreq='220.39868420GHz', linespw='1', 
            robust=[1.0],imsize=1600,cellsize='0.025arcsec'),
        ### 12CO images
        "12CO":dict(chanstart='-100.0km/s', chanwidth='0.635km/s', 
        ...
        ### c-C3H2 217.82 GHz Images
        "c-C3H2_217.82":dict(chanstart='-15km/s', chanwidth='1.34km/s', 
            nchan=30, linefreq='217.82215GHz', linespw='4', robust=[2.0],imsize=1600,cellsize='0.025arcsec'),
        ### c-C3H2 217.94 GHz Images
        "cC3H2_217.94":dict(chanstart='-15km/s', chanwidth='1.34km/s', 
            nchan=30, linefreq='217.94005GHz', linespw='4', robust=[2.0],imsize=1600,cellsize='0.025arcsec'),
        ### c-C3H2 218.16 GHz Images
        "cC3H2_218.16":dict(chanstart='-15km/s', chanwidth='1.34km/s', 
            nchan=30, linefreq='218.16044GHz', linespw='4', robust=[2.0],imsize=1600,cellsize='0.025arcsec'),
        ### DCN Images
        "DCN":dict(chanstart='-15km/s', chanwidth='1.34km/s', nchan=30, 
...
for line in image_list_sb:
    for robust in image_list_sb[line]["robust"]:
        ...
        sigma = get_sensitivity(data_params_sb, specmode='cube', \
                spw=[image_list_sb[line]["linespw"]], chan=450,robust=robust,
                imsize=image_list_sb[line]["imsize"], cellsize=image_list_sb[line]["cellsize"])
...
for line in image_list:
    ...
    for robust in image_list[line]["robust"]:
        ...
        sigma = get_sensitivity(data_params, specmode='cube', \
                ...
                uvtaper=image_list[line]["uvtaper"][0])
