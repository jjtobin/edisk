...
SB1: 
 uid___A002_Xeb6c00_X22e.ms

LB1: 
 uid___A002_Xf160b6_X2ea8.ms (Oct. 4, 2021) 

LB2: 
 uid___A002_Xf1bb4a_X13a53.ms (from 20-Oct-2021/11:00:19.6 to 20-Oct-2021/12:16:11.2 (UTC))

LB3:
 uid___A002_Xf1bb4a_X13eed.ms (12:25 Oct. 20, 2021)
...
field   = {'SB':'Ced110IRS4', 'LB':'Ced110IRS4'}
prefix  = 'Ced110IRS4' 
...
pl_data_params={'SB1': {'vis': SB_path+'uid___A002_Xeb6c00_X22e.ms',
                        ...
                        'field': field['SB'],
                        'column': 'corrected'},
                'LB1': {'vis': LB_path+'uid___A002_Xf160b6_X2ea8.ms',
                        'spws': '25,27,29,31,33,35,37',
                        'field': field['LB'],
                        'column': 'corrected'},
                'LB2': {'vis': LB_path+'uid___A002_Xf1bb4a_X13a53.ms',
                        'spws': '25,27,29,31,33,35,37',
                        'field': field['LB'],
                        'column': 'corrected'},
                'LB3': {'vis': LB_path+'uid___A002_Xf1bb4a_X13eed.ms',
                        'spws': '25,27,29,31,33,35,37',
                        'field': field['LB'],
                        'column': 'corrected'},
               }
...
data_params = {'SB1': {'vis' : WD_path+prefix+'_SB1.ms',
                       ...
                       'phasecenter': '',
                       'timerange': '2021/04/24/01:30:00~2021/04/24/03:00:00',
               ...
               'LB1': {'vis' : WD_path+prefix+'_LB1.ms',
                       ...
                       'cont_avg_width':  np.array([480,480,480,480,60,60,60]), #n channels to average; approximately aiming for 30 MHz channels
                       'phasecenter': '',
                       'timerange': '2021/10/04/13:00:00~2021/10/04/15:00:00',
                       'contdotdat' : 'SB/cont.dat'
                      }, 
               'LB2': {'vis' : WD_path+prefix+'_LB2.ms',
                       ...
                       'cont_avg_width':  np.array([480,480,480,480,60,60,60]), #n channels to average; approximately aiming for 30 MHz channels
                       'phasecenter': '',
                       'timerange': '2021/10/20/11:00:00~2021/10/20/12:30:00',
                       'contdotdat' : 'SB/cont.dat'
                      },
                'LB3': {'vis' : WD_path+prefix+'_LB3.ms',
                       ...
                       'cont_avg_width':  np.array([480,480,480,480,60,60,60]), #n channels to average; approximately aiming for 30 MHz channels
                       'phasecenter': '',
                       'timerange': '2021/10/20/12:20:00~2021/10/20/13:50:00',
                       'contdotdat' : 'SB/cont.dat'
                      }, 
               }
...
#mask_ra  =  '11h06m46.373s'.replace('h',':').replace('m',':').replace('s','')
#mask_dec = '-77d22m32.896s'.replace('d','.').replace('m','.').replace('s','')
#mask_pa  = 90.0 # position angle of mask in degrees
#mask_maj = 0.1	# semimajor axis of mask in arcsec
#mask_min = 0.1 	# semiminor axis of mask in arcsec
...
# !!! Difference between the derived phasecenter and intensity peak estimated by eye is less than ~0.01''
# !!!  so should be negregible
...
# !!! Used the result for EB1 (EB1 and EB2 are comparable in SNR and their SNR is better than EB3.). 
for i in data_params.keys():
       #################### MANUALLY SET THIS ######################
       data_params[i]['common_dir']='J2000 11h06m46.37687s -077d22m32.881218s'
...
if not skip_plots:
    ...
    plot_deprojected(export_vislist,
                     ...
                     show_err=False,outfile='amp-vs-uv-distance-initial.png')
...
if not skip_plots:
   ...
   plot_deprojected(export_vislist_rescaled,
                     ...
                     show_err=False,outfile='amp-vs-uv-distance-initial-after-scaling.png')
...
tclean_wrapper(vis=vislist, imagename=prefix+'_initial', 
               ...
               imsize = 1600, cellsize = '.03arcsec', # newly added line
...
#Ced110IRS4_initial.image.tt0
#Beam 0.379 arcsec x 0.210 arcsec (11.60 deg)
#Flux inside disk mask: 117.39 mJy
#Peak intensity of source: 36.67 mJy/beam
#rms: 1.80e-01 mJy/beam
#Peak SNR: 204.22
...
#[13.61489624 10.06087423  7.43459137  5.49387137  4.05975543  3.        ]
...
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 120.38 mJy
#Peak intensity of source: 44.60 mJy/beam
#rms: 2.00e-01 mJy/beam
#Peak SNR: 223.08

#Ced110IRS4_SB-only_p0_post.image.tt0
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 123.07 mJy
#Peak intensity of source: 45.89 mJy/beam
#rms: 1.65e-01 mJy/beam
#Peak SNR: 277.77


iteration=1
self_calibrate(prefix,data_params,selectedVis,mode='SB-only',iteration=iteration,selfcalmode='p',nsigma=10.06,solint='inf',
               noisemasks=[common_mask,noise_annulus],
...
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 122.36 mJy
#Peak intensity of source: 45.79 mJy/beam
#rms: 1.63e-01 mJy/beam
#Peak SNR: 280.21

#Ced110IRS4_SB-only_p1_post.image.tt0
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 123.38 mJy
#Peak intensity of source: 53.57 mJy/beam
#rms: 8.13e-02 mJy/beam
#Peak SNR: 658.85


iteration=2
self_calibrate(prefix,data_params,selectedVis,mode='SB-only',iteration=iteration,selfcalmode='p',nsigma=7.43,solint='90.72s',
               noisemasks=[common_mask,noise_annulus],
               SB_contspws=SB_contspws,SB_spwmap=SB_spwmap,parallel=parallel)
...
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 122.23 mJy
#Peak intensity of source: 53.75 mJy/beam
#rms: 6.67e-02 mJy/beam
#Peak SNR: 806.32

#Ced110IRS4_SB-only_p2_post.image.tt0
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 122.39 mJy
#Peak intensity of source: 56.34 mJy/beam
#rms: 6.07e-02 mJy/beam
#Peak SNR: 928.91


iteration=3
self_calibrate(prefix,data_params,selectedVis,mode='SB-only',iteration=iteration,selfcalmode='p',nsigma=5.49,solint='42.34s',
               noisemasks=[common_mask,noise_annulus],
               SB_contspws=SB_contspws,SB_spwmap=SB_spwmap,parallel=parallel)
...
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 122.20 mJy
#Peak intensity of source: 56.43 mJy/beam
#rms: 5.91e-02 mJy/beam
#Peak SNR: 954.19

#Ced110IRS4_SB-only_p3_post.image.tt0
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 122.37 mJy
#Peak intensity of source: 59.67 mJy/beam
#rms: 5.82e-02 mJy/beam
#Peak SNR: 1025.06

iteration=4
self_calibrate(prefix,data_params,selectedVis,mode='SB-only',iteration=iteration,selfcalmode='p',nsigma=4.06,solint='18.14s',
               noisemasks=[common_mask,noise_annulus],
               SB_contspws=SB_contspws,SB_spwmap=SB_spwmap,parallel=parallel)
...
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 122.25 mJy
#Peak intensity of source: 59.69 mJy/beam
#rms: 5.50e-02 mJy/beam
#Peak SNR: 1085.23

#Ced110IRS4_SB-only_p4_post.image.tt0
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 122.86 mJy
#Peak intensity of source: 62.04 mJy/beam
#rms: 5.41e-02 mJy/beam
#Peak SNR: 1147.15


# !!! Keep going with phase only because SNR can be still improved

iteration=5
self_calibrate(prefix,data_params,selectedVis,mode='SB-only',iteration=iteration,selfcalmode='p',nsigma=3.00,solint='int',
               noisemasks=[common_mask,noise_annulus],
               SB_contspws=SB_contspws,SB_spwmap=SB_spwmap,parallel=parallel)
...
#Ced110IRS4_SB-only_p5.image.tt0
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 122.71 mJy
#Peak intensity of source: 62.09 mJy/beam
#rms: 5.18e-02 mJy/beam
#Peak SNR: 1198.26

#Ced110IRS4_SB-only_p5_post.image.tt0
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 123.62 mJy
#Peak intensity of source: 63.31 mJy/beam
#rms: 5.20e-02 mJy/beam
#Peak SNR: 1217.90
...
#Ced110IRS4_SB-only_p6.image.tt0
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 123.47 mJy
#Peak intensity of source: 63.29 mJy/beam
#rms: 5.15e-02 mJy/beam
#Peak SNR: 1228.60

#Ced110IRS4_SB-only_p6_post.image.tt0
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 123.47 mJy
#Peak intensity of source: 63.31 mJy/beam
#rms: 5.15e-02 mJy/beam
...
# !!! phase only self-cal stopes here cuz no more improvement is expected
...
#Ced110IRS4_SB-only_p7.image.tt0
#Beam 0.448 arcsec x 0.257 arcsec (12.22 deg)
#Flux inside disk mask: 123.48 mJy
#Peak intensity of source: 63.29 mJy/beam
#rms: 5.15e-02 mJy/beam
#Peak SNR: 1228.52

#Ced110IRS4_SB-only_p7_post.image.tt0
#Beam 0.450 arcsec x 0.258 arcsec (12.22 deg)
#Flux inside disk mask: 123.09 mJy
#Peak intensity of source: 63.56 mJy/beam
...
#Ced110IRS4_SB-only_ap8.image.tt0
#Beam 0.450 arcsec x 0.258 arcsec (12.22 deg)
#Flux inside disk mask: 123.12 mJy
#Peak intensity of source: 63.55 mJy/beam
#rms: 4.88e-02 mJy/beam
#Peak SNR: 1301.37

#Ced110IRS4_SB-only_ap8_post.image.tt0
#Beam 0.451 arcsec x 0.257 arcsec (12.26 deg)
#Flux inside disk mask: 122.99 mJy
#Peak intensity of source: 63.69 mJy/beam
...
#Ced110IRS4_SB-only_ap9.image.tt0
#Beam 0.451 arcsec x 0.257 arcsec (12.26 deg)
#Flux inside disk mask: 122.99 mJy
#Peak intensity of source: 63.67 mJy/beam
#rms: 4.89e-02 mJy/beam
#Peak SNR: 1302.91
...
#Ced110IRS4_initial_LB+SB.image.tt0
#Beam 0.068 arcsec x 0.044 arcsec (-11.00 deg)
...
#Suggested Solints:
#['inf', 'inf', 'inf', '18.14s', 'int']
#Suggested Gaincal Combine params:
#['spw,scan', 'spw','spw', 'spw', 'spw']
#Suggested nsigma per solint: 
#[23.10533333, 13.86961776,  8.3256231 ,  4.99768639,  3.        ]
...
iteration=0
self_calibrate(prefix,data_params,selectedVis,mode='LB+SB',iteration=iteration,selfcalmode='p',nsigma=23.22,solint='inf',
               noisemasks=[common_mask,noise_annulus],
...
#Ced110IRS4_LB+SB_p0.image.tt0
#Beam 0.074 arcsec x 0.048 arcsec (-8.11 deg)
#Flux inside disk mask: 104.65 mJy
#Peak intensity of source: 7.07 mJy/beam
#rms: 1.72e-02 mJy/beam
#Peak SNR: 410.91


#Ced110IRS4_LB+SB_p0_post.image.tt0
#Beam 0.075 arcsec x 0.049 arcsec (-7.22 deg)
#Flux inside disk mask: 106.59 mJy
#Peak intensity of source: 7.57 mJy/beam
#rms: 1.52e-02 mJy/beam
#Peak SNR: 496.89

iteration=1
self_calibrate(prefix,data_params,selectedVis,mode='LB+SB',iteration=iteration,selfcalmode='p',nsigma=13.87,solint='inf',
               noisemasks=[common_mask,noise_annulus],
...
#Ced110IRS4_LB+SB_p1.image.tt0
#Beam 0.075 arcsec x 0.049 arcsec (-7.22 deg)
#Flux inside disk mask: 96.14 mJy
#Peak intensity of source: 7.48 mJy/beam
#rms: 1.49e-02 mJy/beam
#Peak SNR: 502.40

#Ced110IRS4_LB+SB_p1_post.image.tt0
#Beam 0.075 arcsec x 0.049 arcsec (-7.22 deg)
#Flux inside disk mask: 96.51 mJy
#Peak intensity of source: 8.68 mJy/beam
#rms: 1.25e-02 mJy/beam
#Peak SNR: 694.84

iteration=2
self_calibrate(prefix,data_params,selectedVis,mode='LB+SB',iteration=iteration,selfcalmode='p',nsigma=8.32,solint='inf',
               noisemasks=[common_mask,noise_annulus],
               SB_contspws=SB_contspws,SB_spwmap=SB_spwmap,LB_contspws=LB_contspws,LB_spwmap=LB_spwmap,combine='spw',parallel=parallel,smoothfactor=2.0)

#Ced110IRS4_LB+SB_p2.image.tt0
#Beam 0.075 arcsec x 0.049 arcsec (-7.22 deg)
#Flux inside disk mask: 88.85 mJy
#Peak intensity of source: 8.56 mJy/beam
#rms: 1.17e-02 mJy/beam
#Peak SNR: 731.27

#Ced110IRS4_LB+SB_p2_post.image.tt0
#Beam 0.075 arcsec x 0.049 arcsec (-7.22 deg)
#Flux inside disk mask: 88.87 mJy
#Peak intensity of source: 8.58 mJy/beam
#rms: 1.17e-02 mJy/beam
#Peak SNR: 733.14
...
#Ced110IRS4_LB+SB_p3.image.tt0
#Beam 0.075 arcsec x 0.049 arcsec (-7.22 deg)
#Flux inside disk mask: 86.63 mJy
#Peak intensity of source: 8.57 mJy/beam
#rms: 1.17e-02 mJy/beam
#Peak SNR: 734.08

#Ced110IRS4_LB+SB_p3_post.image.tt0
#Beam 0.075 arcsec x 0.049 arcsec (-7.22 deg)
#Flux inside disk mask: 86.70 mJy
#Peak intensity of source: 8.90 mJy/beam
#rms: 1.16e-02 mJy/beam
#Peak SNR: 765.70


#redoing iteration 4 with ap selfcal
iteration=4
...
#Ced110IRS4_LB+SB_p4.image.tt0
#Beam 0.073 arcsec x 0.047 arcsec (-8.30 deg)
#Flux inside disk mask: 94.13 mJy
#Peak intensity of source: 8.57 mJy/beam
#rms: 1.17e-02 mJy/beam
#Peak SNR: 733.45


#Ced110IRS4_LB+SB_p4_post.image.tt0
#Beam 0.075 arcsec x 0.049 arcsec (-6.27 deg)
#Flux inside disk mask: 83.65 mJy
#Peak intensity of source: 8.98 mJy/beam
...
#Ced110IRS4_LB+SB_ap5.image.tt0
#Beam 0.072 arcsec x 0.047 arcsec (-7.55 deg)
#Flux inside disk mask: 95.10 mJy
...
#fINAL ROBUST=0.5 IMAGE HAS HIGHER NOISE THAN FINAL AP SELFCAL IMAGE. LIKELY
#SCALING IS THROWING OFF THE SELF-CALIBRATION SOLUTIONS GIVEN THAT SOURCE IS HAVING ITS DATA ALTERED
###############################################################
########################### CLEANUP ###########################
###############################################################
...
#REPEATED HERE TO ENSURE IT GETS SEEN
print('IF AND ONLY IF SCALING WAS NOT ALREADY SET IN SCRIPT')
print('COPY AND PLACE WHERE DESIGNATED FOR SCALING TOWARD TOP OF SCRIPT')
for i in data_params.keys():
   gencal_scale[i]=data_params[i]['gencal_scale']
   print('data_params["{}"]["gencal_scale"]={:0.3f}'.format(i,data_params[i]['gencal_scale']))
