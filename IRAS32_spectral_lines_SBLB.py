...
""" Starting matter """
sys.path.append('/DATA/frankie/edisk/edisk') #CHANGE THIS TO YOUR PATH TO THE SCRIPTS!
...
# the script sends out an email when a line is done.
#emailmsg    = ""
#emailsub    = ""
#emailadd    = "frankie.enc@gmail.com"
...
for line in image_list:
   ...
   #emailmsg = "iras 32: " + str(line) + " done."
   #os.system("echo '{}' | mail -s '{}' '{}'".format(emailmsg, emailsub, emailadd))
