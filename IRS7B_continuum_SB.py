...
WD_path = '/lustre/cv/projects/edisk/IRS7B-demo-test/'
SB_path = WD_path+'SB/'
LB_path = WD_path+'LB/'
...
data_params = {'SB1': {'vis' : WD_path+prefix+'_SB1.ms',
                       'name' : 'SB1',
                       'field': field,
                       'line_spws': np.array([0,0,0,0,0,0]), # line SPWs, get from listobs
                       'line_freqs': np.array([217.82215e9,217.94005e9,218.16044e9,217.2386e9,
                                               218.22219200e9,218.47563200e9]), #restfreqs
                       'line_names': ['c-C3H2','c-C3H2','c-C3H2','DCN','H2CO','H2CO'], #restfreqs
                       'flagrange': np.array([[-5.5,14.5],[-5.5,14.5],[-5.5,14.5],[-5.5,14.5],
                                              [-5.5,14.5],[-5.5,14.5]]),
                       'orig_spw_map':  {33:0, 35:1},  # mapping of old spws to new spws (needed for cont.dat to work)
                       'cont_spws':  np.array([0,1]),  #spws to use for continuum
                       'cont_avg_width':  np.array([3840,3840]), #n channels to average; approximately aiming for 30 MHz channels
                       'phasecenter': '',
...
for i in data_params.keys():
       #################### MANUALLY SET THIS ######################
       data_params[i]['common_dir']='J2000 19h01m56.419591s -36d57m28.64864s'
...
#IRS7B_dirty.image.tt0
#Beam 0.281 arcsec x 0.214 arcsec (39.99 deg)
#Flux inside disk mask: 454.85 mJy
#Peak intensity of source: 124.53 mJy/beam
#rms: 1.45e+00 mJy/beam
#Peak SNR: 86.13
...
#Beam 0.281 arcsec x 0.214 arcsec (39.99 deg)
#Flux inside disk mask: 383.24 mJy
#Peak intensity of source: 118.02 mJy/beam
#rms: 4.95e-01 mJy/beam
#Peak SNR: 238.29

#IRS7B_SB-only_p0_post.image.tt0
#Beam 0.281 arcsec x 0.214 arcsec (39.99 deg)
#Flux inside disk mask: 386.99 mJy
#Peak intensity of source: 120.92 mJy/beam
#rms: 4.42e-01 mJy/beam
#Peak SNR: 273.78
...
#Beam 0.281 arcsec x 0.214 arcsec (39.99 deg)
#Flux inside disk mask: 360.40 mJy
#Peak intensity of source: 119.02 mJy/beam
#rms: 2.06e-01 mJy/beam
#Peak SNR: 578.30

#IRS7B_SB-only_p1_post.image.tt0
#Beam 0.281 arcsec x 0.214 arcsec (39.99 deg)
#Flux inside disk mask: 360.43 mJy
#Peak intensity of source: 120.65 mJy/beam
...
#Beam 0.073 arcsec x 0.057 arcsec (83.83 deg)
#Flux inside disk mask: 428.47 mJy
#Peak intensity of source: 25.62 mJy/beam
#rms: 4.87e-02 mJy/beam
#Peak SNR: 525.61

#IRS7B_LB+SB_p1_post.image.tt0
#Beam 0.073 arcsec x 0.057 arcsec (83.83 deg)
#Flux inside disk mask: 427.78 mJy
#Peak intensity of source: 25.58 mJy/beam
...
iteration=4
self_calibrate(prefix,data_params,mode='LB+SB',iteration=iteration,selfcalmode='p',nsigma=10.0,solint='24.24s',
               noisemasks=[common_mask,noise_annulus],
               SB_contspws=SB_contspws,SB_spwmap=SB_spwmap,LB_contspws=LB_contspws,LB_spwmap=LB_spwmap,parallel=parallel,smoothfactor=2.0,imsize=14400)
...
iteration=5
self_calibrate(prefix,data_params,selectedVis,mode='LB+SB',iteration=iteration,selfcalmode='p',nsigma=5.0,solint='12.12s',
               noisemasks=[common_mask,noise_annulus],
               SB_contspws=SB_contspws,SB_spwmap=SB_spwmap,LB_contspws=LB_contspws,LB_spwmap=LB_spwmap,parallel=parallel,smoothfactor=2.0,imsize=14400)
...
self_calibrate(prefix,data_params,mode='LB+SB',iteration=iteration,selfcalmode='ap',prevselfcalmode='p',nsigma=3.0,solint='300s',
               noisemasks=[common_mask,noise_annulus],
               SB_contspws=SB_contspws,SB_spwmap=SB_spwmap,LB_contspws=LB_contspws,LB_spwmap=LB_spwmap,parallel=parallel,combine='scan,spw',smoothfactor=2.0,imsize=14400)
