...
LB1: 2019.1.00261.L (08/10/2021)
     
LB2: 2019.1.00261.L (08/10/2021)
...
data_params = {'SB1': {'vis' : WD_path+prefix+'_SB1.ms',
               ...
               'LB1': {'vis' : WD_path+prefix+'_LB1.ms',
                       ...
                       'cont_spws':  np.array([0,1,2,3,4,5,6]),  #spws to use for continuum
                       'cont_avg_width':  np.array([60,60,60,60,60,60,60]), #n channels to average; approximately aiming for 30 MHz channels
                       'phasecenter': '',
...
for i in data_params.keys():
   data_params[i]['common_mask']=common_mask
   data_params[i]['noise_annulus']=noise_annulus
...
self_calibrate(prefix,data_params,selectedVis,mode='SB-only',iteration=iteration,selfcalmode='p',nsigma=40.0,solint='inf',
               noisemasks=[data_params['SB1']['common_mask'],data_params['SB1']['noise_annulus']],
...
iteration=6
self_calibrate(prefix,data_params,selectedVis,mode='SB-only',iteration=iteration,selfcalmode='ap',nsigma=3.0,solint='18s',
               noisemasks=[data_params['SB1']['common_mask'],data_params['SB1']['noise_annulus']],SB_contspws=SB_contspws,SB_spwmap=SB_spwmap,
...
for robust in [-2.0,-1.0,-0.5,0.0,0.5,1.0,2.0]:
    ...
    ##adjust sigma to corrector for the irregular noise in the images
    ...
    tclean_wrapper(vis=vislist, imagename=imagename, sidelobethreshold=2.0, 
            ...
            noisethreshold=noisethreshold, robust=robust, parallel=parallel, 
